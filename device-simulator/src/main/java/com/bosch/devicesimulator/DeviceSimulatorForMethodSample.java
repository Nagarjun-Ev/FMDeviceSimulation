...
public class DeviceSimulatorForMethodSample {
	 ...
	 */
	    ...
	    {
	        System.out.println("invoking method on this device");
	        ...
	        public DeviceMethodData call(String methodName, Object methodData, Object context)
	        {
	            ...
	            switch (methodName)
	            {
	                ...
	                default:
	                {
	                    ...
	                    deviceMethodData = new DeviceMethodData(status, "Method Not Found with name " + methodName);
	                }
	            }
